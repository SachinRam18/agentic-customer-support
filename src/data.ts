import { Customer, Order, Invoice, Ticket, FAQItem, SupportPolicy, SubscriptionPlan, SubscriptionStatus } from "./types";

export const initialCustomers: Customer[] = [
  {
    id: "CUST101",
    name: "John Smith",
    email: "john@cloudbox.com",
...
export const initialTickets: Ticket[] = [
  {
    ...
    customerId: "CUST101",
    customerName: "John Smith",
    subject: "Sync delay on macOS application",
    category: "Technical Issues",
    status: "In Progress",
    priority: "Medium",
    createdDate: "2026-05-30 14:22",
    lastUpdatedDate: "2026-05-31 09:15",
    messages: [
      {
        sender: "customer",
        text: "Hi, I have updated to macOS Sonoma and my synced files take several minutes to appear locally. On my mobile app, they show up instantly.",
        timestamp: "2026-05-30 14:22"
      },
      {
        sender: "ai-agent",
        text: "Hello John, thank you for reaching out! I checked our sync health logs and your Professional tier storage quota contains plenty of buffer. I classified this as a Local Cache Sync Delay. Let's try force-killing the daemon or resetting the folder permissions. Would you like me to raise a Technical ticket for full analysis?",
        timestamp: "2026-05-30 14:25"
      },
      {
        sender: "customer",
        text: "Yes, please escalate this to a specialist. Resetting folder keys didn't completely resolve it.",
        timestamp: "2026-05-31 09:10"
      },
      {
        sender: "human-agent",
        text: "Hi John, I am a support engineer. I have assigned engineering ticket CB-9821 to inspect local system events logs. I'll check in with you shortly.",
  ...
  },
  {
    ...
    customerId: "CUST102",
    customerName: "Sarah Johnson",
    subject: "Refund request for double-billing",
    category: "Refunds",
    status: "Open",
    priority: "High",
    createdDate: "2026-06-01 08:30",
    lastUpdatedDate: "2026-06-01 08:30",
    messages: [
      {
        sender: "customer",
        text: "Hello, my starter plan auto-renewed and I wanted to cancel. Also, I see two identical charges of ₹199 on my statement. I'd like a refund of the extra charge please.",
  ...
  },
  {
    ...
    customerId: "CUST103",
    customerName: "Michael Brown",
    subject: "Request custom terms invoice sharing",
    category: "Billing",
    status: "Resolved",
    priority: "Low",
    createdDate: "2026-05-10 11:00",
    lastUpdatedDate: "2026-05-11 16:30",
    messages: [
      {
        sender: "customer",
        text: "Can we configure the monthly invoices to be sent to billing-hub@corporate.com in addition to my primary email? This is for our enterprise cost center validation.",
        timestamp: "2026-05-10 11:00"
      },
      {
        sender: "human-agent",
        text: "Hello Michael, I have successfully updated group distribution on your profile billing node. Future Enterprise plan invoices will copy billing-hub@corporate.com automatically.",
...
export const supportPolicies: SupportPolicy[] = [
  {
    id: "pol_refund",
